            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <select name="cate_pid">
                            ...
                            @foreach($data as $k => $v)
                                <option value="{{$v->id}}"
                                        @if($v->id == $field->cate_pid) selected="selected" @endif
                                >{{$v->cate_name}}</option>
                            @endforeach
                        </select>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span><i class="fa fa-exclamation-circle yellow"></i>分类名称不能为空</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input style="width:5%" type="text" name="cate_order" value="{{$field->cate_order}}">
                    </td>
                </tr>
                <tr>
                    <th></th>
