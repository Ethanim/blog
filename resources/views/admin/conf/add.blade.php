        ...
        <form action="{{url('admin/config')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="conf_title" name="conf_title">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="conf_name" name="conf_name">
                ...
                <tr>
                    <th>类型：</th>
                    <td>
                        <input type="radio" name="field_type" onclick="showTr()" checked value="input">input　
                        <input type="radio" name="field_type" onclick="showTr()" value="textarea">textarea　
                        <input type="radio" name="field_type" onclick="showTr()" value="radio">radio
                    </td>
                </tr>
                <tr class="field_value">
                    <th>类型值：</th>
                    <td>
                        <input type="text" class="lg" id="field_value" name="field_value"><br />
                ...
                <tr>
                    <th>排序：</th>
                    <td>
                        <input style="width:5%" type="text" name="conf_order" value="0">
                    </td>
                </tr>
                <tr>
                    <th>说明：</th>
