...
@section('content')
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="http://www.enoch.site" target="_blank" >http://www.enoch.site</a></span>
                </li>
                <li>
                    <label>官方交流QQ群：</label><span><a href="#" class="QQ" ><img border="0" src="http://pub.idqqimg.com/wpa/images/group.png"></a></span>
                </li>
            </ul>
        </div>
    </div>
