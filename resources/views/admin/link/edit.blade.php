...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 友情链接修改
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="{{url('admin/links/'.$field->id)}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="link_name" name="link_name" value="{{$field->link_name}}">
                        <span><i class="fa fa-exclamation-circle yellow"></i>友情链接名称不能为空</span>
                    </td>
                </tr>
                <tr>
                    <th>友情链接标题：</th>
                ...
                <tr>
                    <th>友情链接排序：</th>
                    <td>
                        <input style="width:5%" type="text" name="link_order" value="{{$field->link_order}}">
                    </td>
                </tr>
                <tr>
                    <th></th>
