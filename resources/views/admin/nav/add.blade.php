...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 自定义导航添加
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="{{url('admin/navs')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="nav_name" name="nav_name">
                ...
                <tr>
                    <th>导航排序：</th>
                    <td>
                        <input style="width:5%" type="text" name="nav_order" value="0">
                    </td>
                </tr>
                <tr>
                    <th></th>
